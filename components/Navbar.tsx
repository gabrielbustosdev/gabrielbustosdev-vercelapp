        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <button className="bg-gradient-to-r from-blue-500 to-slate-600 text-white px-6 py-2 rounded-full hover:from-blue-600 hover:to-slate-700 transition-all duration-300 font-medium">
                Hablar con AI
              </button>
            </div>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-black/30 backdrop-blur-md rounded-lg mt-2">
              {navItems.map((item) => (
                <Link
                  ...
                  className={`block px-3 py-2 transition-colors duration-300 ${
                    isActive(item.href) ? "text-blue-400 bg-blue-500/10 rounded-lg" : "text-white hover:text-blue-400"
                  }`}
              ...
              <button className="w-full text-left bg-gradient-to-r from-blue-500 to-slate-600 text-white px-3 py-2 rounded-lg hover:from-blue-600 hover:to-slate-700 transition-all duration-300 mt-2">
                Hablar con AI
              </button>
            </div>
          </div>
